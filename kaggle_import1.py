...
connection.commit()
"""
for i in range (len(lst_migration[1:])):
    cursor.execute('''insert into net_migration (country_fk,net_migration,add_date) values (trim(:1),:2,TO_DATE('2020/05/2', 'yyyy/mm/dd'))''',lst_migration[1:][i])
connection.commit()
"""
